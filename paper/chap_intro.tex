...
In contextul optimizării de programe este nevoie sa definim ce
înseamnă ca dintre doua programe echivalente \s{P} și \s{Q}, \s{P}
sa fie mai performant decât \s{Q}.
...
Vom spune ca \s{P} este mai rapid decât \s{Q} pe baza timpului de
...
Având definita relația de ordine, problema optimizării pe
baza metricii de viteza este:

Dându-se un program \s{P}, sa se găsească \s{Q} ca cel mai rapid
...
Dându-se un program \s{P}, sa se găsească \s{Q} ca cel mai mic
program echivalent cu \s{P}:
